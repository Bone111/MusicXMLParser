...
typedef NS_ENUM(NSInteger, ENotationType) {
    ENotationType_Begin =0 ,
    ENotationType_End,
    ENotationType_Continue,
};

typedef NS_ENUM(NSInteger, ENotationPlacement) {
    ENotationPlacement_Above =0 ,
    ENotationPlacement_Below,
};
...
@interface NotationM : NSObject
@property(nonatomic, assign) ENotationType mValue;
@property(nonatomic, assign) ENotationChioce mChoice;
@property(nonatomic, assign) NSInteger mNumber;
@property(nonatomic, strong) NoteGroupM* mEnd;
@property(nonatomic, assign) ENotationPlacement mPlacement;
