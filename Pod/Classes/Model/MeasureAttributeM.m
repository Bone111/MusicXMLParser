...
+ (void)loadImages {
    if (images_init == 0) {
        ...
        images[2] = [UIImage imageForResource:@"two" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] ;
        images[3] = [UIImage imageForResource:@"three" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] ;
        images[4] = [UIImage imageForResource:@"four" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] ;
        images[6] = [UIImage imageForResource:@"six" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] ;
        images[8] = [UIImage imageForResource:@"eight" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] ;
        images[9] = [UIImage imageForResource:@"nine" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] ;
        images[12] = [UIImage imageForResource:@"twelve" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] ;
    }
    images_init = 1;
}
...
-(void)drawClef:(double*)x_offset {
    ...
    if (self.mClef.mValue == EClef_TREBLE) {
        image = [UIImage imageForResource:@"treble" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]];
        height = 3 * PartHeight/2 + NoteHeight/2;
        y =  - NoteHeight;
    }
    else if (self.mClef.mValue == EClef_BASS) {
        image =[UIImage imageForResource:@"bass" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]];
